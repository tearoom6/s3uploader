...
export default {
  config: {
    ...
    s3BucketCustomUrl: {
      title: 'S3 bucket custom URL',
      description: 'Specify if you wanna replace default one',
      type: 'string',
      default: '',
      order: 2,
    },
    ...
    s3PlatformType: {
      title: 'S3 compatible platform type',
      type: 'string',
      default: 'aws',
      enum: ['aws', 'minio'],
      order: 4,
    ...
    s3PlatformUrl: {
      title: 'S3 compatible platform URL',
      description: 'You need to specify this when using MinIO',
      type: 'string',
      default: '',
      order: 5,
    },
    s3AccessKeyId: {
      ...
      description: 'You can also specify this with aws config file',
      type: 'string',
      default: '',
      order: 6,
    },
    ...
    markdownListingCharacter: {
      title: 'Listing character',
      description: 'Listing character of Markdown when uploading multiple files',
      type: 'string',
      default: '-',
      order: 9,
    },
